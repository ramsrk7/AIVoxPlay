...
#asyncio.run(tts_engine.speak(text="Hello, setting up the server.."))
...
qsession = QueueSession(engine=tts_engine, voice="coral")
...
if __name__ == "__main__":
    uvicorn.run("stream_server_openai:app", host="0.0.0.0", port=8080)
